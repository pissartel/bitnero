...
/**
 * inspired by https://github.com/EXXETA/android-examples/blob/main/Keystore-Example/app/src/main/java/com/exxeta/keystoreexample/CryptoToolboxImpl.kt
 */
actual fun createEncryptedToolbox(): EncryptedToolbox = object : EncryptedToolbox {

    private val context: Context = APP_CONTEXT_INSTANCE

    private val KEY = "private_key"
    private val KEYSTORE_PROVIDER_NAME = "AndroidKeyStore"
    private val CIPHER = "RSA/ECB/OAEPPadding"
    private val ENCRYPTED_SHARED_PREFS = "ENCRYPTED_SHARED_PREFS"
    private val ENCRYPTED_SHARED_PREFS_FILENAME = "shared_prefs"
